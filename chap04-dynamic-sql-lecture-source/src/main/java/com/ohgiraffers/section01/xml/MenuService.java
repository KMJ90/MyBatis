...
public class MenuService {
    ...
    public void searchMenuByRandomMenuCodeList(List<Integer> randomMenuCodeList) {
        ...
        List<MenuDTO> menuList = mapper.searchMenuByRandomMenuCodeList(criteria);
    ...
    public void selectMenuByCodeOrSearchAll(SearchCriteria searchCriteria) {

        SqlSession sqlSession = getSqlSession();
        mapper = sqlSession.getMapper(DynamicSqlMapper.class);

        List<MenuDTO> menuList = mapper.selectMenuByCodeOrSearchAll(searchCriteria);
