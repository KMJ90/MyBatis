...
public class Application {
    ...
    private static void foreachSubMenu() {
        ...
        do {
            ...
            System.out.println("9. 이전 메뉴로");
            System.out.print("메뉴 번호 입력하세요 : ");
            int no = sc.nextInt();

            switch (no) {
                case 1 : menuService.searchMenuByRandomMenuCodeList(createRandomMenuCodeList()); break;
                case 9 : return;
            }
        } while (true);
    }
    ...
    private static List<Integer> createRandomMenuCodeList() {
        ...
        // Set : 순서유지 X, 중복허용 X  중복된 값이 들어가면 안들어가짐
    ...
    private static void trimSubMenu() {
        ...
        do {
            ...
            System.out.println("2. 메뉴명 혹은 카테고리 코드로 검색, 단 메뉴와 카테고리 둘 다 일치하는 경우도 검색하며," +
                    "검색조건이 없는 경우 전체 검색");
            ...
            switch (no) {
                case 1 : menuService.selectMenuByCodeOrSearchAll(inputAllOrOne()); break;
    ...
    private static Map<String, Object> inputSearchCriteriaMap() {
        ...
        Scanner sc = new Scanner(System.in);
        System.out.println("검색조건을 입력하세요(category or name or both or null) : ");
        String condition = sc.nextLine();
